...
<body>
    ...
    <div class="cart-box-main">
        <div class="col-sm-12 col-lg-12 mb-12">
            <form action="${loginLink}" name="" method="POST" class="login">
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <label for="InputEmail" class="mb-0">Email Address</label>
                        <input name="username" type="text" class="form-control" id="InputEmail" placeholder="Enter Email"> </div>
                    <div class="form-group col-md-12">
                        <label for="InputPassword" class="mb-0">Password</label>
                        <input name="password" type="password" class="form-control" id="InputPassword" placeholder="Password"> </div>
                </div>
                <input type="submit" class="btn hvr-hover" value="Login">
            </form>
        </div>
    </div>
    <!-- End Login -->
